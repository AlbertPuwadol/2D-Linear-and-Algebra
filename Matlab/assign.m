...
% Last Modified by GUIDE v2.5 07-Dec-2019 20:11:48
...
function Alps2_Callback(hObject, eventdata, handles)
% hObject    handle to Alps2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Alps2 as text
%        str2double(get(hObject,'String')) returns contents of Alps2 as a double


% --- Executes during object creation, after setting all properties.
function Alps2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Alps2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in AlpsButton.
function AlpsButton_Callback(hObject, eventdata, handles)
% hObject    handle to AlpsButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
